...
@file rotation_MPC_bullet.py
@author Sebastien Kleff
@license License BSD-3-Clause
@copyright Copyright (c) 2020, New York University and LAAS-CNRS
@date 2020-05-18
@brief Closed-loop MPC for EE frame rotation task 
"""
...
if __name__=='__main__':
    if(len(sys.argv) < 2 or len(sys.argv) > 3):
        print("Usage: python rotation_MPC.py [arg1: robot_name (str)] [arg2: simulator (str)] [arg3: PLOT_INIT (bool)]")
        sys.exit(0)
    elif(len(sys.argv)==2):
