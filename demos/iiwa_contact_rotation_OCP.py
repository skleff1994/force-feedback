...
# # # # # # # # # # # # 
# Read config file
config = path_utils.load_config_file('iiwa_contact_rotation_OCP')
...
for k,m in enumerate(models):
    ...
    # # Contact model
    # m.differential.contacts.contacts["contact"].contact.reference.translation = M_ee.translation.copy() 
...
# Classical warm start using initial config
    ...
    f_ext = pin_utils.get_external_joint_torques(M_ee.copy(), config['frameForceRef'], robot)
