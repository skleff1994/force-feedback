...
def main(robot_name='iiwa', simulator='bullet', PLOT_INIT=False):
  ...
  for n_exp in range(len(TILT_RPY)):
    ...
    draw_rate = 200
    # print(robot_simulator.robotId)
    # print(contact_surface_bulletId)
    # print(ballsId)
...
if __name__=='__main__':
    if(len(sys.argv) < 2 or len(sys.argv) > 3):
        print("Usage: python LPF_contact_circle_MPC.py [arg1: robot_name (str)] [arg2: simulator (str)] [arg3: PLOT_INIT (bool)]")
        sys.exit(0)
    elif(len(sys.argv)==2):
