...
class DDPDataPlotterAbstract:
    def __init__(self):
        '''
        Helper class to plot OCP results from Crocoddyl
        note that results, state and control plots are 'virtual' functions
        '''
        pass
...
class MPCDataPlotterAbstract:
    def __init__(self):
        '''
        Helper for MPC simulation data plots
        '''
        pass
